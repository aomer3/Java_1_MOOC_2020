...
public class Story {
    ...
    public static void main(String[] args) {
        ...
        //This task asks the user to enter the name of the main character and then stores the user input.
        System.out.println("I will tell you a story, but I need some information first.");
        System.out.println("What is the main character called?");
        String name = scanner.nextLine();

        //This task asks the user to enter the character's job and then stores the user input.
        System.out.println("What is their job?");
        String job = scanner.nextLine();

        //This task displays a story onto the screen, including the user-created name and job where applicable.
