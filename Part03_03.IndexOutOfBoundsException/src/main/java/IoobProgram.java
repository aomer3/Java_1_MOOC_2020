/*
There is a program that uses a list in the exercise template. Modify it so that
its execution always produces the error IndexOutOfBounds. The user should not have
to give any inputs to the program (e.g. write something on the keyboard).
*/
...
public class IoobProgram {
    ...
    public static void main(String[] args) {
        ...
        //This line will cause an IndexOutOfBoundsException because it is referencing a non-existent seventh element in the list.
